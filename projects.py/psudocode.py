...
y for clolect it
n for leave it
when you are asked to atack
f for fight
r for run
'a' to list the 'map' of the place
...
enemy_boosts = {
    ...
    "BOSS": {"health": r.randint(10,20), "speed": r.randint(10,20),"defence": r.randint(10,20),"strength": r.randint(10,20)}
}
...
def enemy_stats(enemy):
    ...
    if enemy == "BOSS": return {"health": 80, "speed": 3, "defence": 2, "strength": 30}
